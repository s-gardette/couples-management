"""create_expenses_tables

Revision ID: 2025_05_28_1130
Revises: add_user_role_and_admin_fields
Create Date: 2025-05-28 11:30:00.000000
...
revision: str = '2025_05_28_1130'
down_revision: Union[str, None] = 'add_user_role_and_admin_fields'
...
def upgrade() -> None:
    ...
    op.execute("""
        DO $$ BEGIN
            CREATE TYPE userhouseholdrole AS ENUM ('admin', 'member');
        EXCEPTION
    ...
    op.create_table('user_households',
        ...
        sa.Column('role', sa.Enum('admin', 'member', name='userhouseholdrole'), nullable=False),
